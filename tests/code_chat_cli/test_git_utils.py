...
class TestGetGitDiff:
    ...
    def test_get_git_diff_staged_exists_success(self):
    ...
    def test_get_git_diff_unstaged_fallback_success(self):
        ...
        with patch("subprocess.check_output") as mock_check_output:
            ...
            mock_check_output.assert_any_call(
                ["git", "diff"], text=True, encoding="utf-8"
            )

    def test_get_git_diff_called_process_error_failure(self):
    ...
    def test_get_git_diff_file_not_found_error_failure(self, mock_check_output):
    ...
    def test_get_git_diff_no_diff(self):
